...
@section('header_title', 'Who Can Attend (Participants) Settings')
...
<div class="page-title">Who Can Attend (Our Participants) Settings</div>
...
<form method="POST" action="{{ route('admin.participants.update') }}">
    @csrf
    ...
    <!-- 5 Participant Categories -->
    <div class="config-card">
        <div class="card-header">
            <div class="card-title">
                <i class="fa-solid fa-users"></i>
                Participant Category Cards (5 Categories)
            </div>
        </div>
        ...
        <div class="card-box-item">
            <div class="badge-item">
                <i class="fa-solid fa-user"></i> Participant Category {{ $i }}
            </div>
            <div class="grid-2">
                <div class="form-group">
                    <label class="form-label">Category Name / Label</label>
                    <input type="text" name="part_{{ $i }}_label" class="form-control" value="{{ $settings['part_' . $i . '_label'] ?? '' }}">
                </div>
                <div class="form-group">
                    <label class="form-label">FontAwesome Icon Class</label>
                    <input type="text" name="part_{{ $i }}_icon" class="form-control" value="{{ $settings['part_' . $i . '_icon'] ?? 'fa-solid fa-user' }}" placeholder="fa-solid fa-graduation-cap">
                </div>
            </div>
        </div>
        @endfor
